...
public class Account {
    ...
    public Date getColUpdateTime() {
        return colUpdateTime;
    }

    public void setColUpdateTime(Date colUpdateTime) {
    ...
    public Date getColLoginTime() {
        return colLoginTime;
    }

    public void setColLoginTime(Date colLoginTime) {
