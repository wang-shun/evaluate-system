...
public class ExamPaperSubjectService
{
    ...
    //根据试题类型和试题总数组装试卷
    public  List<ExamSubject> acessmble(String subjectType,int count,int subjectDbId) {
      
        List<Subject> subjects=subjectMapper.querySubject(count, subjectDbId, Integer.valueOf(subjectType));
